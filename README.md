# amazon-lambda-random-shutdown-failure Project
...
You can then execute your native executable with: `./build/amazon-lambda-random-shutdown-failure-1.0.0-SNAPSHOT-runner`
